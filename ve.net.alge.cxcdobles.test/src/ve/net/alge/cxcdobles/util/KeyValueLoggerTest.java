...
package ve.net.alge.cxcdobles.util;

import static ve.net.alge.cxcdobles.test.util.RandomTestUtil.*;
import static ve.net.alge.cxcdobles.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"ve.net.alge.cxcdobles.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"ve.net.alge.cxcdobles.util\"");
	}
