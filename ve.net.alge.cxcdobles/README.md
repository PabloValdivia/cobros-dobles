# Cobros Duplicados CxC

## Standard

- New callout
    * Name: CName
    * Package: ve.net.alge.cxcdobles.callout
    * Example: ve.net.alge.cxcdobles.callout.CStringFormat

- New process
    * Name: PName
    * Package: ve.net.alge.cxcdobles.process
    * Example: ve.net.alge.cxcdobles.process.PGenerateWithholding

- New form
    * Name: FName
    * Package: ve.net.alge.cxcdobles.form
    * Example: ve.net.alge.cxcdobles.form.FMultiPayment

- New event
    * Name: EName
    * Package: ve.net.alge.cxcdobles.event
    * Example: ve.net.alge.cxcdobles.event.EAfterCompleteInvoice

- New model (extends class X)
    * Name: MName
    * Package: ve.net.alge.cxcdobles.model
    * Example: ve.net.alge.cxcdobles.model.MTableExample

## Folder estructure

```
    ve.net.alge.cxcdobles
        |_.settings
...
- New callout
    * Create callout in package `ve.net.alge.cxcdobles.callout`, extends from `CustomCallout`
    * Register callout in `ve.net.alge.cxcdobles.component.CalloutFactory`. Example:
...
- New process
    * Create process in package `ve.net.alge.cxcdobles.process`, extends from `CustomProcess`
    * Register process in `ve.net.alge.cxcdobles.component.ProcessFactory`. Example:
...
- New form
    * Create form in package `ve.net.alge.cxcdobles.form`, extends from `CustomForm`
    * Register form in `ve.net.alge.cxcdobles.component.FormFactory`. Example:
...
- New event
    * Create event in package `ve.net.alge.cxcdobles.event`, extends from `CustomEvent`
    * Register event in `ve.net.alge.cxcdobles.component.EventFactory`. Example:
...
- New model (extends form class X)
    * Create model in package `ve.net.alge.cxcdobles.model`, extends class `X`. Example: `X_TL_TableExample -> MTableExample`
    * Register model in `ve.net.alge.cxcdobles.component.ModelFactory`. Example:
