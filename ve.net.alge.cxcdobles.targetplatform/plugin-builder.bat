...
call mvn validate -Didempiere.target=ve.net.alge.cxcdobles.p2.targetplatform %DEBUG_MODE%
call mvn verify -Didempiere.target=ve.net.alge.cxcdobles.p2.targetplatform %DEBUG_MODE%
